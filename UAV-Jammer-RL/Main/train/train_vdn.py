"""
MP-DQN (VDN) cooperative training script.
...
def train_mpdqn_vdn(
    ...
    pbar = trange(n_episode, desc="Training(MP-DQN-VDN)", unit="ep", ascii=True)
    try:
        for episode in pbar:
            states = vecenv.reset()
    ...
    if save_data:
        save_training_data(
            ...
            run_config={
                ...
                "lr_mixer_note": "VDN mixer has no learnable parameters; lr_mixer is ignored except for interface symmetry.",
                "epsilon_start": 1.0,
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Starting MP-DQN VDN Training")
    print("=" * 60)
    train_mpdqn_vdn(
